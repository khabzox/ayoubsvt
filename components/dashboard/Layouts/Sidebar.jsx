...
const Sidebar = () => {
  return (
    <>
      <div className=" text-white h-screen w-14 bg-primLaboHov">
        {/* Sidebar content */}
            ...
            return (
              <>
                <Link
                  href={nav.linkTo}
                  key={nav.id}
                  className="bg-white hover:bg-[#e1e0ff] rounded-md text-primLaboHov w-8 text-center justify-center flex h-8 ml-3 mb-4"
                >
                  <TooltipProvider>
                    <Tooltip>
